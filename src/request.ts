...
export const requests = {
  ...
  fetchNetflixOriginals: `${BASE_URL}${API_KEY}&with_networks=213&watch_region=JP&language=ja-JP`,
  ...
  fetchNewsMovies: `${BASE_URL}${API_KEY}&with_genres10763&watch_region=JP&language=ja-JP`,
